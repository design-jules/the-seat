    ...
    <main>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <p className="eyebrow eyebrow-on-dark hero-anim-1">The Seat Method</p>
      ...
      <section className="section meet-section">
        <div className="section-inner">
          ...
          <div className="personas-display-grid">
            ...
            <Reveal delay={0} className="persona-float-card">
            ...
            <Reveal delay={120} className="persona-float-card">
            ...
            <Reveal delay={240} className="persona-float-card">
